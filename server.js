...
const twilioPhoneNumber = '+15854548309';
...
app.post('/soil-moisture', (req, res) => {
  ...
  } else if (moisture > 35 && !isSMSSentHigh) {
    sendSMS('Soil moisture is above 35%. Turn off the pump.');
    isSMSSentHigh = true;
    isSMSSentLow = false;
  }
...
app.listen(port, () => {
    console.log(`Server is running on http://172.20.10.7:${port}`);
});
